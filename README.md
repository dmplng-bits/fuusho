...
Full implementation: `app/backend/pairing.py`.
...
**One-click PaaS button:** not live yet — needs this repo to be pushed
to a public GitHub URL first. `railway.json`/`render.yaml` aren't
included yet either; ping the maintainer or open an issue if you want
one prioritized.
