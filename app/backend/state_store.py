...
DATABASE_FILE_PATH = os.environ.get("DB_PATH", "/data/fuusho.sqlite3")

STATE_CATEGORY_NAMES = {
    # Registered APNs devices — shape documented in backend/routes.py
    "devices",
    # In-flight QR pairing sessions, keyed by token — shape documented in
    # backend/pairing.py. Short-lived (~90s) and pruned lazily on access.
    "pairingSessions",
}
